    ...
    return (
        <>
                ...
                <SwiperSlide>
                    <div className={styles.slide1}>
                        <div className={styles.context1}>
                            ...
                            <h1>Minimal Menz Style</h1>
                            <p>Consectetur adipisicing elit. Laborum fuga incidunt laboriosam voluptas iure, delectus dignissimos facilis neque nulla earum.</p>
                            <Link to="/products?category=men's clothing" className={styles.shop}>Shop Now</Link>
                        </div>
                        <img src={hero1} alt="" />
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className={styles.slide2}>
                        <div className={styles.context2}>
                            ...
                            <h1>Minimal Menz Style</h1>
                            <p>Consectetur adipisicing elit. Laborum fuga incidunt laboriosam voluptas iure, delectus dignissimos facilis neque nulla earum.</p>
                            <Link to="/products?category=women's clothing">Shop Now</Link>
                        </div>
                        <img src={hero2} alt="" />
                    </div>
                </SwiperSlide>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.image}>
                    <h1>Men's Fashion</h1>
                    <Link to="/products?category=men's clothing">Shop Now</Link>
                    <img src={item1} alt="" />
                </div>
                </Link>
                ...
                <Link to="/products?category=baby's clothing">
                <div className={styles.image}>
                    <h1>Baby Fashion</h1>
                    <Link to="/products?category=baby's clothing">Shop Now</Link>
                    <img src={item3} alt="" />
                </div>
                </Link>
            </div>
